<template>
    ...
    <nav class="bg-red-500 h-16 px-4 sm:px-4 fixed w-full z-20 top-0 left-0">
        <div class="items-center mx-auto w-full max-w-screen-2xl flex flex-wrap justify-between pt-2 md:pt-0">
            ...
            <button data-collapse-toggle="navbar-default" type="button" class="inline-flex items-center p-2 ml-3 text-sm text-gray-100 rounded-lg md:hidden hover:bg-[#d14a4a] focus:outline-none focus:ring-2 focus:ring-red-600" aria-controls="navbar-default" aria-expanded="false">
